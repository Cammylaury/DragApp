//
//  GoogleAndFacebookBtns.swift
//  Dragnet
//
//  Created by Cameron Laury on 9/4/17.
//  Copyright © 2017 com.CamGlam.DragNet. All rights reserved.
//
...
public class GoogleAndFacebookBtns : NSObject {

    //// Drawing Methods

    @objc dynamic public class func drawFacebookCircleButton(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 67, height: 67), resizing: ResizingBehavior = .aspectFit) {
    ...
    @objc dynamic public class func drawGoogleCircleButton(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 67, height: 67), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc(GoogleAndFacebookBtnsResizingBehavior)
